...
<body>
	...
	<div class="container-fluid register-page">
		<div class="row justify-content-center">
			<span class="search-result px-4 py-2 mb-2 rounded">Formulaire de
				Préinscription</span>
		</div>
		...
		<div class="row session justify-content-center">
			<div class="col-8">
				<div class="card text-center">
					<div class="card-body">
						<h5 class="card-title home">${courseSession.course.titre}</h5>
						<p class="card-text">
					...
					<div class="card-footer">Nombre de pré-inscrits :
		...
		<div class="row justify-content-center">
			<c:if test="${success == true}">
				<div class="col-6 alert alert-success alert-dismissible fade show"
					role="alert">
